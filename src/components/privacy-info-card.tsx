    ...
    <Card className="border-green-200 bg-green-50/50">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-green-800">
          <div className="flex items-center justify-center w-6 h-6 bg-white/70 rounded-full p-1">
            <Image 
              src="/icon.png"
      ...
      <CardContent className="space-y-3 text-sm">
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="font-medium text-green-800">完全クライアントサイド処理</p>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="font-medium text-green-800">データの保護</p>
            <p className="text-green-700">
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="font-medium text-green-800">高品質変換</p>
            <p className="text-green-700">
